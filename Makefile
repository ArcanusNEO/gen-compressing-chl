...
unchl: unchl.cpp
	g++ -DREAD_LENGTH=$(READ_LENGTH) -DMX_READ_LIST_SZ=$(MX_READ_LIST_SZ) -DHASH_TABLE_SZ=$(HASH_TABLE_SZ) -DUSE_FS_SIM -std=c++17 -fdiagnostics-color=always -O3 -mcmodel=medium -ounchl unchl.cpp
